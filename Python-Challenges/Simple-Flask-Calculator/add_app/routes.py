# Import modules from flask and the current application context
from flask import current_app as app, request, jsonify
# Import the Blueprint object from the __init__.py file wihtin the same package
from __init__ import add_bp
